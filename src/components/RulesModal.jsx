export const RulesModal = () => {
    return <div className='w-full h-full bg-black bg-opacity-50 absolute z-40 grid place-items-center'>
        <div
            ...
            <div className='flex justify-center sm:justify-between w-full mb-12'>
                ...
                <img src="/src/assets/images/icon-x-button.svg" className='hidden sm:inline object-contain'
                     alt="close button"/>
            </div>
