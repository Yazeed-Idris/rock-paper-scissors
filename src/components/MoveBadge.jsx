                    ...
                    <div
                        ...
                        <div className='bg-white w-fit rounded-full'>
                            <div className='bg-black rounded-full pt-2 bg-opacity-25'>
                                <div className='bg-white rounded-full grid place-items-center w-26 h-24 sm:w-36 sm:h-34 opacity-100'>
                                    <img className='object-contain sm:w-24 sm:h-20' src='/src/assets/images/icon-paper.svg'
                                         alt='paper badge'/>
                                </div>
                            </div>
                        </div>
            ...
            <div className='bg-black bg-opacity-30 w-fit rounded-full pb-2'>
                <div
                    ...
                    <div className='bg-white w-fit rounded-full'>
                        <div className='bg-black rounded-full pt-2 bg-opacity-25'>
                            <div className='bg-white rounded-full grid place-items-center w-26 h-24 sm:w-36 sm:h-34 opacity-100'>
                                <img className='object-contain sm:w-24 sm:h-20' src='/src/assets/images/icon-scissors.svg'
                                     alt='scissors badge'/>
                            </div>
                        </div>
                    </div>
